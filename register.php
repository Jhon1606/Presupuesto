...
<head>
    ...
    <style>
        ...
        .bg{
            background-image: url('Public/img/imglogin2.jpg');
    ...
    <div class="container w-75 bg-primary mt-5 rounded shadow">
        <div class="row align-items-stretch">
            ...
            <div class="col bg-white p-5 rounded-end" >
                ...
                <form action="Usuario/Controlador/register.php" method="POST">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="apellido" placeholder="Nombre Completo..." class="form-control">
                    </div>
                    <div class="mb-4">
